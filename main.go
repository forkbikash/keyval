...
import (
	...
	httpd "github.com/forkbikash/keyval/http"
	"github.com/forkbikash/keyval/store"
)
...
func main() {
	...
	log.Printf("keyval started successfully, listening on http://%s", httpAddr)

	terminate := make(chan os.Signal, 1)
	signal.Notify(terminate, os.Interrupt)
	<-terminate
	log.Println("keyval exiting")
}
